...
$desciption="Here you can add/edit/delete Categories"
@endphp
@section('title')
    {{$pagetitle}}
@endsection
                     ...
                     <tr>
                        <td>{{$row->id}}</td>
                         ...
                         <td class="td-actions text-right">
                             <a href="{{route('categories.edit',$row->id)}}"  rel="tooltip" title="" class="btn btn-white btn-link btn-sm" data-original-title="Edit">

...
$desciption="Here you can add/edit/delete Skills"
@endphp
@section('title')
    {{$pagetitle}}
@endsection
                     ...
                     <tr>
                        <td>{{$row->id}}</td>
                         ...
                         <td class="td-actions text-right">
                             <a href="{{route('skills.edit',$row->id)}}"  rel="tooltip" title="" class="btn btn-white btn-link btn-sm" data-original-title="Edit">
                                 <i class="material-icons">edit</i>
                             </a>
                             <form  method="POST" action="{{route('skills.destroy',$row->id)}}">
                                @csrf
                                 @method('DELETE')
